 ...
 * @info: identified as the parameter struct
 *
 * Return: the provided string containg history file
 */
...
/**
 * write_history - it creates a file, or combines it  to an existing file
